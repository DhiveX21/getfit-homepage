        ...
        <div className="flex flex-wrap ">
          ...
          <div className="w-1/2 lg:w-1/4 p-1">
            <div className="bg-pink shadow rounded text-white flex flex-wrap items-center px-2 h-24">
              ...
              {/* card content */}
              <div className="pl-6">
                <div className=" font-light text-xs">Total Appointment</div>
                <div className="font-bold">
                  50 <span className="font-light text-sm">Orang</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-1/2 lg:w-1/4 p-1">
            <div className="bg-pink shadow rounded text-white flex flex-wrap items-center px-2 h-24">
              ...
              {/* card content */}
              <div className="pl-6">
                <div className="font-light text-xs">Pending Appointment</div>
