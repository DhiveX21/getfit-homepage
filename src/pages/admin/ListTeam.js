...
import ListTeamTable from "parts/admin/listTeam/listTeamTable";
  ...
  let template = {
    fields: [
      ...
      },
      {
        ...
        name: "description",
        placeholder:
          "Cth : Education And Training Manager di Lembaga Vokasi Universitas Indonesia.  Lecturer University of Indonesia.  Senior Physiotherapist OM Active Clinic",
        validationProps: {
      ...
      },
      {
        ...
        type: "text",
        name: "position",
        placeholder: "Cth : Physiotherapist",
        validationProps: {
      ...
      },
      {
        ...
        name: "url",
        placeholder:
          "Cth : https://id.linkedin.com/in/faizah-abdullah-24a332b3",
      },
    ],
  };
    ...
    <>
      ...
      <div className="relative ml-16 mr-2 mt-16 z-0 md:ml-68 md:mr-4 md:mt-18">
        ...
        <div className="flex justify-end">
          ...
          >
            <div className="mr-1">Tambah Tim </div>
            <span className="">
